...
export const translations: Record<Locale, Dictionary> = {
  en: {
    ...
    form: {
      ...
      goalExample: 'Explain this site clearly for a first-time visitor, focusing on the 3 or 4 most important points.',
  ...
  ja: {
    ...
    form: {
      ...
      goalExample: 'このサイトを初めて見る人が理解できるよう要点を3つ、4つに絞って分かりやすく解説してください。',
